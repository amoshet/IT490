...
def on_request(ch, method, props, body):
    rabbitMSG = body
    //rabbitMSG is going to come as a dictionary like this: rabbitMSG = { 'query': 'some sql statement', 'params' : 'the parameters needed to pass for example email'}
    print(rabbitMSG) 
    rabbitResponse = "goodbye from db"  //HERE is where you would replace this string after initial test and put a call to executeSQL function that puts in query and params*see backend server on_request secion
