...
def decider(type, rabbitMsg):
	return{
		...
		'getAuto' : lambda data : getAuto(rabbitMsg.get('AutoComplete')),
		'getList' : lambda data : getAuto(rabbitMsg.get('List')),
		'getDetail' : lambda data : getAuto(rabbitMsg.get('Detail'))
